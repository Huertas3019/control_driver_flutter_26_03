...
@JsonKey(includeIfNull: false) String? get id; String get userId; String get brand; String get model; int get year; String get licensePlate; String? get nickname;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) Timestamp get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,brand,model,year,licensePlate,nickname,createdAt);

@override
String toString() {
  return 'Vehicle(id: $id, userId: $userId, brand: $brand, model: $model, year: $year, licensePlate: $licensePlate, nickname: $nickname, createdAt: $createdAt)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? id, String userId, String brand, String model, int year, String licensePlate, String? nickname,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) Timestamp createdAt
});
...
/// Create a copy of Vehicle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? userId = null,Object? brand = null,Object? model = null,Object? year = null,Object? licensePlate = null,Object? nickname = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? id,  String userId,  String brand,  String model,  int year,  String licensePlate,  String? nickname, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  Timestamp createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Vehicle() when $default != null:
return $default(_that.id,_that.userId,_that.brand,_that.model,_that.year,_that.licensePlate,_that.nickname,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? id,  String userId,  String brand,  String model,  int year,  String licensePlate,  String? nickname, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  Timestamp createdAt)  $default,) {final _that = this;
switch (_that) {
case _Vehicle():
return $default(_that.id,_that.userId,_that.brand,_that.model,_that.year,_that.licensePlate,_that.nickname,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _Vehicle implements Vehicle {
  const _Vehicle({@JsonKey(includeIfNull: false) this.id, required this.userId, required this.brand, required this.model, required this.year, required this.licensePlate, this.nickname, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) required this.createdAt});
...
/// Create a copy of Vehicle
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? userId = null,Object? brand = null,Object? model = null,Object? year = null,Object? licensePlate = null,Object? nickname = freezed,Object? createdAt = null,}) {
